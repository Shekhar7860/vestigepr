...
const advert = firebase.admob().interstitial('ca-app-pub-3550043356338169/5235704561')
...
setTimeout(() => {
 ...
 <Banner
       style={{alignSelf:'center',marginLeft:15, marginTop:10}}
    size={"SMALL_BANNER"}
  unitId={"ca-app-pub-3550043356338169/1408140190"}
